package ph.edu.auf.fragmentslesson.fragments
...
import ph.edu.auf.fragmentslesson.databinding.FragmentSendDataBinding
...
class SendDataFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtSendMessageOne.text = param1
        binding.txtSendMessageTwo.text = param2
    }
